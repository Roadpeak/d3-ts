  ...
  return (
    <div className='hidden md:flex flex-col w-[15%] h-[100vh] p-4 bg-gray-600'>
      ...
      <div className="flex flex-col gap-2 mt-4">
        ...
        <Link to={`/${id}/discounts`} className='text-white px-3 py-2 hover:bg-gray-400 rounded-md'>Discounts</Link>
        <Link to={`/${id}/sales`} className='text-white px-3 py-2 hover:bg-gray-400 rounded-md'>Sales</Link>
        <Link to={`/${id}/appointments`} className='text-white px-3 py-2 hover:bg-gray-400 rounded-md'>Appointments</Link>

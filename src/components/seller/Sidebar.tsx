  ...
  return (
    <div className='hidden md:flex flex-col w-[15%] h-[100vh] p-4 bg-primary'>
      ...
      <div className="flex flex-col gap-2 mt-4">
        ...
        <Link to={'/'} className='text-white px-3 py-2 hover:bg-rose-300 rounded-md'>Discounts</Link>
        <Link to={'/'} className='text-white px-3 py-2 hover:bg-rose-300 rounded-md'>Sales</Link>

        ...
        <div className="bg-gradient-to-r from-black to-white min-h-screen flex justify-center items-center">
            <div className="bg-white p-8 rounded-lg shadow-md w-96">
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-2xl font-semibold text-black">Seller Sign In</h1>
                </div>
                <form onSubmit={handleSubmit}>
                    ...
                    <p className="text-sm text-gray-700 text-start mt-4 mb-1">Don't have a seller account? <Link to='/accounts/sign-up' className="text-red-500">Create</Link></p>
                    <div className="mb-4">
